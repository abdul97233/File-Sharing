    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL_1:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/ntmchat for support")
                sys.exit()
        ...
        # self.LOGGER(__name__).info(f"Developer:- @abdul97233")
        self.LOGGER(__name__).info(f"Bot Running..!\n\nCreated by \nhttps://t.me/NTMPRo")
        self.LOGGER(__name__).info(f""" \n\n       
ooooo      ooo ooooooooooooo ooo        ooooo 
`888b.     `8' 8'   888   `8 `88.       .888' 
 8 `88b.    8       888       888b     d'888  
 8   `88b.  8       888       8 Y88. .P  888  
 8     `88b.8       888       8  `888'   888  
 8       `888       888       8    Y     888  
o8o        `8      o888o     o8o        o888o 
                                          """)
